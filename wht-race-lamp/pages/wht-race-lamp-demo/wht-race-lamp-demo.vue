<template>
  <view class="demo-container">
    <view class="page-header">
      <view class="page-title">wht-race-lamp 跑马灯</view>
      <view class="page-desc">支持水平和垂直方向的文字滚动效果，可自定义左侧图标、滚动方向、速度等</view>
    </view>
    ...
    <view class="demo-card">
      ...
      <view class="demo-card__content">
        ...
        <view class="demo-item">
          ...
          <wht-race-lamp direction="up" height="80" :speed="40" :gap="5">
            <view class="direction-text">
